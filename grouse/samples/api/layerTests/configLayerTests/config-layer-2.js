...
$.getScript('../../../../rv-main.js', function () {
                ...
                configLayer.attributesRemoved.subscribe((l) => {
                    ...
                    if (remAttrib) {
                        ...
                        if (configLayer.getAttributes(5) === undefined && configLayer.getAttributes(10) !== undefined) {
                            ...
                            console.log(
                                'Test failed because attribute was not removed successfully, or removed wrong attribute'
                            );
    ...
    $('#main').append(`
        <div id="fgpmap" style="height:700px; width:70%; margin-left:10px" class="column" rv-langs='["en-CA", "fr-CA"]' rv-service-endpoint="http://section917.canadacentral.cloudapp.azure.com/""></div>
    `);
