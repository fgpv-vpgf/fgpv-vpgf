        ...
        attrBundle.layer._layerProxy.formattedAttributes.then(function (a) {
            Object.keys(a.rows[0]).forEach(function (columnName) {
                if (columnName === 'rvSymbol' ||
                    ...
                    var column = new config_manager_1.ColumnConfigManager(_this.configManager, columnName);
                    var colDef = {
                        ...
                        sort: column.sort,
                        hide: _this.configManager.filteredAttributes.length === 0 ? false : column.column ? !column.column.visible : undefined
                    };
