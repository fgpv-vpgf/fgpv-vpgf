...
var CustomHeader = /** @class */ (function () {
    ...
    CustomHeader.prototype.init = function (agParams) {
        ...
        this.headerButton.addEventListener('click', function (event) {
            _this.agParams.progressSort(event.shiftKey);
        });
        this.headerButton.addEventListener('touchstart', function (event) {
            _this.agParams.progressSort(event.shiftKey);
        });
    ...
    CustomHeader.prototype.destroy = function () {
        ...
        var onSortChangedListener = this.onSortChanged.bind(this);
        var onColumnReorderListener = this.onColumnReorder.bind(this);
        this.headerButton.removeEventListener('click', function (event) {
            _this.agParams.progressSort(event.shiftKey);
        });
        this.headerButton.removeEventListener('touchstart', function (event) {
            _this.agParams.progressSort(event.shiftKey);
        });
