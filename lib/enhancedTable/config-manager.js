...
var ConfigManager = /** @class */ (function () {
    ...
    Object.defineProperty(ConfigManager.prototype, "defaultGlobalSearch", {
         ...
         */
        get: function () {
            var searchText = this.tableConfig.search.value === undefined ? '' : this.tableConfig.search.value;
            return searchText;
        },
        enumerable: true,
        configurable: true
    ...
    */
    ConfigManager.prototype.setColumnVisibilities = function (column) {
        if (!column.visible) {
     ...
     */
    ConfigManager.prototype.initColumns = function () {
        var _this = this;
        this.tableConfig.columns.forEach(function (column) {
            _this.setColumnVisibilities(column);
        });
    };
...
var ColumnConfigManager = /** @class */ (function () {
    function ColumnConfigManager(configManager, colData) {
     ...
     * Helper method
     */
    ColumnConfigManager.prototype.findColumn = function (colData) {
        var matchingColumn;
        this.configManager.tableConfig.columns.forEach(function (column) {
