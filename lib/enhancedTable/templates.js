...
exports.DETAILS_TEMPLATE = function (oid) {
    return "<button ng-controller='DetailsAndZoomCtrl as ctrl' ng-click='ctrl.openDetails(" + oid + ")' md-ink-ripple class='md-icon-button rv-icon-16 md-button ng-scope enhanced-table-details' aria-label=\"{{ 't.detailsAndZoom.details' | translate }}\">\n        <md-icon md-svg-src=\"action:description\" aria-hidden='false' class='ng-scope' role='img'>\n            <md-tooltip  md-direction=\"top\">{{ 't.detailsAndZoom.details' | translate }}</md-tooltip>\n        </md-icon>\n    </button>";
};
exports.ZOOM_TEMPLATE = function (oid) {
    return "<button ng-controller='DetailsAndZoomCtrl as ctrl' ng-click='ctrl.zoomToFeature(" + oid + ")'  md-ink-ripple class='md-icon-button rv-icon-16 md-button ng-scope enhanced-table-zoom' aria-label=\"{{ 't.detailsAndZoom.zoom' | translate }}\">\n        <md-icon md-svg-src=\"action:zoom_in\" aria-hidden='false'>\n            <md-tooltip  md-direction=\"top\">{{ 't.detailsAndZoom.zoom' | translate }}</md-tooltip>\n        </md-icon>\n    </button>";
};
