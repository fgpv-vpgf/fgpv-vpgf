...
class WeeklyBuilder:
    ...
    def __init__(self, username, password):
        ...
        Args:
            username: github username authorized to merge PRs
...
- [Production Builds](http://fgpv.cloudapp.net/demo/users/milesap/build/weekly-1.4.0-7/prod/samples/)
- [Developer Builds](http://fgpv.cloudapp.net/demo/users/milesap/build/weekly-1.4.0-7/dev/samples/)""" % self.next_version

            self.org_repo.create_git_release('weekly-' + self.next_version, title, body, draft=False, prerelease=True)

if __name__ == '__main__':
    build = WeeklyBuilder('github username/email', 'password')
    build.run()
