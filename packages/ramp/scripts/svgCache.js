const iconCache = [
    { file: 'src/content/images/iconsets/default-icons.svg', prefix: 'default', icons: 'check logo northarrow sadpanda flag crosshairs'.split(' '), isDefault: true },
    { file: 'src/content/images/iconsets/action-icons.svg', prefix: 'action', icons: 'settings_input_svideo search home history description delete settings info_outline info visibility visibility_off zoom_in zoom_out check_circle open_in_new print shopping_cart opacity swap_vert touch_app translate cached done map-refresh filter-refresh'.split(' ') },
    ...
    { file: 'src/content/images/iconsets/navigation-icons.svg', prefix: 'navigation', icons: 'menu check more_vert close more_horiz refresh arrow_back arrow_upward arrow_downward fullscreen expand_more expand_less'.split(' ') },
