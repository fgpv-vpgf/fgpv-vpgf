...
<html class="no-js lt-ie9" lang="en" dir="ltr">
    ...
    <html class="no-js" lang="en" dir="ltr">
        ...
        <head>
            ...
            <title>Content page - Base theme - Working examples - Web Experience Toolkit</title>
            <meta content="width=device-width,initial-scale=1" name="viewport">
            <!-- Meta data -->
            <meta name="description" content="Web Experience Toolkit (WET) includes reusable components for building and maintaining innovative Web sites that are accessible, usable, and interoperable. These reusable components are open source software and free for use by departments and external Web communities">
            <!-- Meta data-->
            <!--[if gte IE 9 | !IE ]><!-->
            <link href="https://wet-boew.github.io/themes-dist/theme-base//theme-base/assets/favicon.ico" rel="icon" type="image/x-icon">
            <link rel="stylesheet" href="https://wet-boew.github.io/themes-dist/theme-base//theme-base/css/theme.min.css">
            <!--<![endif]-->
            <!--[if lt IE 9]>
            <link href="https://wet-boew.github.io/themes-dist/theme-base//theme-base/assets/favicon.ico" rel="shortcut icon" />
            <link rel="stylesheet" href="https://wet-boew.github.io/themes-dist/theme-base//theme-base/css/ie8-theme.min.css" />
            <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
            <script src="https://wet-boew.github.io/themes-dist/theme-base//wet-boew/js/ie8-wet-boew.min.js"></script>
            <![endif]-->
            <noscript>
                <link rel="stylesheet" href="https://wet-boew.github.io/themes-dist/theme-base//wet-boew/css/noscript.min.css" />
            </noscript>
            <style>
                .myMap {
                    height: 600px;
        ...
        <body vocab="http://schema.org/" typeof="WebPage">
                    ...
                    <div class="container nvbar">
                        ...
                        <div class="row">
                            <ul class="list-inline menu">
                                <li><a href="https://wet-boew.github.io/themes-dist/theme-base//index-en.html">WET project</a></li>
                                <li><a href="https://wet-boew.github.io/themes-dist/theme-base//docs/start-en.html#implement">Implement WET</a></li>
                                <li><a href="https://wet-boew.github.io/themes-dist/theme-base//docs/start-en.html">Contribute to WET</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                    ...
                    <div class="container">
                        <div class="row">
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="http://wet-boew.github.io/themes-dist/theme-base/index-en.html">Base theme</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <main role="main" property="mainContentOfPage" class="container">
                <h1 id="wb-cont" property="name">Base theme</h1>
            ...
            <script src="https://wet-boew.github.io/themes-dist/theme-base//wet-boew/js/wet-boew.min.js"></script>
            <!--<![endif]-->
            <!--[if lt IE 9]>
            <script src="https://wet-boew.github.io/themes-dist/theme-base//wet-boew/js/ie8-wet-boew2.min.js"></script>
            <![endif]-->
        </body>
    </html>
