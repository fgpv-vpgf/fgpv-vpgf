...
const sampleWktExtent = {
    ...
    spatialReference: {
        wkt:
            'PROJCS["Lambert_Conformal_Canada_NAD83",GEOGCS["GCS_North_American_1983",' +
...
describe('Local projection', () => {
    ...
    it('should project an extent with a WKT spatial reference', () => {
        ...
        const expectedRes = {
            x0: -172.14169532688865,
            y0: 34.89804295089334,
            x1: -11.276472960723352,
            y1: 83.27265193258071,
        }; // jshint ignore:line
    ...
    it('should project a point with a WKT spatial reference', () => {
        const res = proj.localProjectPoint(
            sampleWktExtent.spatialReference.wkt,
            4326,
            [-2293629.397399999, -685380.4041000009]
        ); // jshint ignore:line
    ...
    it('should reproject from mercator to lambert', () => {
        ...
        const expectedRes = {
            x0: -1729118.683387185,
            y0: 74576.19391872548,
            x1: 66964.16600783693,
            y1: 1810940.2344750422,
        }; // jshint ignore:line
