!(function (a, b) {
            ...
            if (r && (i = r.events)) {
                for (b = (b || '').match(E) || [''], j = b.length; j--; )
                    if (((h = Y.exec(b[j]) || []), (o = q = h[1]), (p = (h[2] || '').split('.').sort()), o)) {
                        ...
                        g &&
                            !m.length &&
                            ((l.teardown && !1 !== l.teardown.call(a, p, r.handle)) || n.removeEvent(a, o, r.handle),
                            delete i[o]);
    ...
    (function (t, e) {
        ...
        i.each(d, function (t, e) {
            u[e] = function (e, r, s) {
                return (
                    ((this._listeningTo || (this._listeningTo = {}))[e._listenId || (e._listenId = i.uniqueId('l'))] =
                        e),
        ...
        (N.started = !1),
            i.extend(N.prototype, u, {
                ...
                start: function (t) {
                    ...
                    if (
                        ((this.root = ('/' + this.root + '/').replace(/^\/+|\/+$/g, '/')), n && this._wantsHashChange)
                    ) {
