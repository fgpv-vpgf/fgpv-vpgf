        ...
        module: {
            rules: [
                ...
                },
                {
                    test: /\.s?[ac]ss$/,
                    include: [
                        path.resolve(__dirname, 'src/content/styles'),
                        path.resolve(__dirname, 'node_modules/@fgpv'),
                        path.resolve(__dirname, 'node_modules/colourpicker'),
                    ],
                    use: [
                ...
                },
                {
                    ...
                    include: [
                        ...
                        path.resolve(__dirname, 'node_modules/@claviska'),
                    ],
                    use: 'url-loader',
                },
                {
