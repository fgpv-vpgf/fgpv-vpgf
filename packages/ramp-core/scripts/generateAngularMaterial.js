...
const successHandler = () => {
    ...
    fs.copy(
        './angular_material/angular-material.min.js',
        './src/material/angular-material.min.js',
        { overwrite: true },
        (err) => moveComplete(err, 'angular-material.min.js')
    );
    fs.copy(
        './angular_material/angular-material.themes.min.css',
        './src/material/angular-material.themes.min.css',
        { overwrite: true },
        (err) => moveComplete(err, 'angular-material.themes.min.css')
    );
    fs.copy(
        './.material-cache/1.1.9/module/angular-material.scss',
        './src/material/angular-material.scss',
        { overwrite: true },
        (err) => moveComplete(err, 'angular-material.scss')
    );
    fs.copy('./.material-cache/1.1.9/module/LICENSE', './src/material/LICENSE', { overwrite: true }, (err) =>
        moveComplete(err, 'LICENSE')
    );
};
