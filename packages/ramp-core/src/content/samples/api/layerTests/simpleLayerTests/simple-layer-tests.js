...
$.getScript('../../../../rv-main.js', function () {
    RAMP.mapAdded.subscribe((mapi) => {
        ...
        //svg path as icon
        const SVG = new RAMP.GEO.Point(0, [-85, 59], {
    ...
    $('#main').append(`
        <div id="fgpmap" style="height:700px; width:75%; margin-left:10px" class="column" rv-langs='["en-CA", "fr-CA"]' rv-service-endpoint="http://section917.canadacentral.cloudapp.azure.com/"></div>
    `);
