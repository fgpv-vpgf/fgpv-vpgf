                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="list-inline margin-bottom-none">
                            <li><a lang="fr" href="javascript:toggleLanguage();">English</a></li>
                        </ul>
                    </div>
                </div>
            </section>
          ...
          <div id="fgpSignIn" class="row">
            <div class="panel panel-default">
                <div class="panel-body clearfix">
                    ...
                    <div id="fgpmap" is="rv-map" class="myMap" data-rv-config="config.rcs.[lang].json" data-rv-langs='["fr-CA", "en-CA"]' data-rv-service-endpoint="http://section917.canadacentral.cloudapp.azure.com/" data-rv-wait="true" rv-plugins="backToCart">
                        <noscript>
