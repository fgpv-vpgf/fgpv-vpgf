...
!(function (e, n) {
    ...
    'function' == typeof define && define.amd
        ...
        ? (module.exports = n(require('moment')))
        : n(e.moment);
})(this, function (e) {
    'use strict';
    var n,
    ...
    function u(e) {
        var n = 0,
            ...
            i = 0,
            s = 1;
        for (45 === e.charCodeAt(0) && ((n = 1), (s = -1)); n < a.length; n++) i = 60 * i + f(a.charCodeAt(n));
        for (n = 0; n < r.length; n++) (o /= 60), (i += f(r.charCodeAt(n)) * o);
        return i * s;
    }
    function m(e) {
    ...
    function p(e, n) {
        var t,
            a = [];
        for (t = 0; t < n.length; t++) a[t] = e[n[t]];
        return a;
    }
    function b(e) {
        var n = e.split('|'),
        ...
        return (
            ...
            { name: n[0], abbrs: p(n[1].split(' '), a), offsets: p(t, a), untils: r, population: 0 | n[5] }
        );
    }
    function z(e) {
        e && this._set(b(e));
    ...
    function h(e, n) {
        for (var t, a; (a = 6e4 * (((n.at - e.at) / 12e4) | 0)); )
            (t = new l(new Date(e.at + a))).offset === e.offset ? (e = t) : (n = t);
        return e;
    }
    function d(e, n) {
        return e.offsetScore !== n.offsetScore
            ? e.offsetScore - n.offsetScore
            : e.abbrScore !== n.abbrScore
            ? e.abbrScore - n.abbrScore
            : n.zone.population - e.zone.population;
    }
    function O(e, n) {
        var t, a;
        for (m(n), t = 0; t < n.length; t++) (a = n[t]), (o[a] = o[a] || {}), (o[a][e] = !0);
    }
    function v() {
        try {
        ...
        var t,
            ...
            s = (function () {
                var e,
                    ...
                    r = new l(new Date(a, 0, 1)),
                    o = [r];
                for (t = 1; t < 48; t++)
                    (n = new l(new Date(a, t, 1))).offset !== r.offset &&
                        ((e = h(r, n)), o.push(e), o.push(new l(new Date(e.at + 6e4)))),
                        (r = n);
                for (t = 0; t < 4; t++) o.push(new l(new Date(a + t, 0, 1))), o.push(new l(new Date(a + t, 6, 1)));
                return o;
            })(),
            c = s.length,
            f = (function (e) {
                var n,
                    ...
                    s = {},
                    c = [];
                for (n = 0; n < i; n++) for (t in (a = o[e[n].offset] || {})) a.hasOwnProperty(t) && (s[t] = !0);
                for (n in s) s.hasOwnProperty(n) && c.push(r[n]);
                return c;
            })(s),
            u = [];
        for (a = 0; a < f.length; a++) {
            for (t = new A(w(f[a]), c), i = 0; i < c; i++) t.scoreOffsetAt(s[i]);
            u.push(t);
        }
        return u.sort(d), u.length > 0 ? u[0].zone.name : void 0;
    }
    function _(e) {
    ...
    function g(e) {
        var n, a, o, i;
        for ('string' == typeof e && (e = [e]), n = 0; n < e.length; n++)
            (i = _((a = (o = e[n].split('|'))[0]))), (t[i] = e[n]), (r[i] = a), O(i, o[2].split(' '));
    }
    function w(e, n) {
        e = _(e);
        var o,
        ...
        return i instanceof z
            ...
            ? ((i = new z(i)), (t[e] = i), i)
            : a[e] && n !== w && (o = w(a[e], w))
            ? ((i = t[e] = new z())._set(o), (i.name = r[e]), i)
            : null;
    }
    function S(e) {
        var n, t, o, i;
        for ('string' == typeof e && (e = [e]), n = 0; n < e.length; n++)
            (o = _((t = e[n].split('|'))[0])), (i = _(t[1])), (a[o] = i), (r[o] = t[0]), (a[i] = o), (r[i] = t[1]);
    }
    function T(e) {
        g(e.zones), S(e.links), (M.dataVersion = e.version);
    }
    function C(e) {
        var n = 'X' === e._f || 'x' === e._f;
    ...
    function M(n) {
        ...
        return r && !e.isMoment(n) && C(o) && o.add(r.parse(o), 'minutes'), o.tz(a), o;
    }
    (s < 2 || (2 === s && c < 6)) &&
        D('Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js ' + e.version + '. See momentjs.com'),
        (z.prototype = {
            _set: function (e) {
                (this.name = e.name),
                    (this.abbrs = e.abbrs),
            ...
            _index: function (e) {
                var n,
                    t = +e,
                    a = this.untils;
                for (n = 0; n < a.length; n++) if (t < a[n]) return n;
            },
            parse: function (e) {
                var n,
                    t,
                ...
                for (r = 0; r < c; r++)
                    if (
                        ...
                        (t = i[r + 1]),
                        (a = i[r ? r - 1 : r]),
                        n < t && M.moveAmbiguousForward ? (n = t) : n > a && M.moveInvalidForward && (n = a),
                        o < s[r] - 6e4 * n)
                    )
                        return i[r];
                return i[c];
        ...
        (M.load = T),
        (M.zone = w),
        (M.zoneExists = function e(n) {
            return (
                e.didShowError ||
                    ((e.didShowError = !0),
                    D(
                        "moment.tz.zoneExists('" + n + "') has been deprecated in favor of !moment.tz.zone('" + n + "')"
                    )),
                !!w(n)
            );
        }),
        ...
        (M.names = function () {
            var e,
                n = [];
            for (e in r) r.hasOwnProperty(e) && (t[e] || t[a[e]]) && r[e] && n.push(r[e]);
            return n.sort();
        }),
        (M.Zone = z),
        (M.unpack = b),
        (M.unpackBase60 = u),
        (M.needsOffset = C),
        (M.moveInvalidForward = !0),
        (M.moveAmbiguousForward = !1);
    var y,
        k = e.fn;
    function x(e) {
        return function () {
    ...
    (e.tz = M),
        ...
        (e.updateOffset = function (n, t) {
            var a,
                r = e.defaultZone;
            void 0 === n._z &&
                (r && C(n) && !n._isUTC && ((n._d = e.utc(n._a)._d), n.utc().add(r.parse(n), 'minutes')), (n._z = r)),
                n._z &&
                    ((a = n._z.utcOffset(n)),
                    Math.abs(a) < 16 && (a /= 60),
                    void 0 !== n.utcOffset ? n.utcOffset(-a, t) : n.zone(a, t));
        }),
        (k.tz = function (n, t) {
            return n
                ? ((this._z = w(n)),
        ...
        (k.zoneName = x(k.zoneName)),
        (k.zoneAbbr = x(k.zoneAbbr)),
        (k.utc =
            ((y = k.utc),
            function () {
        ...
        (e.tz.setDefault = function (n) {
            return (
                ...
                (e.defaultZone = n ? w(n) : null),
                e
            );
        });
    var R = e.momentProperties;
    return (
