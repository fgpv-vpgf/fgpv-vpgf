 ...
 *
 */
angular.module('app.ui').directive('rvMetadataContent', rvMetadataContent);
    ...
    function link(scope, el, attr) {
        ...
        scope.$watch('self.display.data', (metadataPackage) => {
            ...
            angular.forEach(metadataElem.find('p'), (pElem) => {
                ...
                pElem.html(
                    $compile(`<rv-truncate max-text-length="${maxTextLength}">${pElem.html()}</rv-truncate>`)(scope)
                );
            });
            ...
            if (metadataPackage.catalogueUrl) {
                amendDiv.append(
                    `<p><a href="${metadataPackage.catalogueUrl}" target="_blank">${$translate.instant(
            ...
            if (metadataPackage.metadataUrl) {
                amendDiv.append(
                    `<p><a href="${metadataPackage.metadataUrl}" target="_blank">${$translate.instant(
