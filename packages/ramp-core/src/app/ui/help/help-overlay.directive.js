 ...
 *
 */
angular.module('app.ui').directive('rvHelpOverlay', rvHelpOverlay);
    ...
    function link(scope, el) {
        ...
        function draw() {
            ...
            items.forEach((item) => {
                ...
                if (shouldBeDrawn(item.key, coords)) {
                    ...
                    context.clearRect(coords.x + 1, coords.y + 1, coords.width - 2, coords.height - 2);
        ...
        function shouldBeDrawn(key, coords) {
            ...
            alreadyDrawn.forEach((drawnItem) => {
                ...
                if (drawnItem.key === key || overlap(drawnItem.coords, coords) || coords.width * coords.height === 0) {
                    valid = false;
                    return;
                }
            });
