 ...
 *     <li>Allow a plugin author to listen for changes on the legend in order to update their plugin
 *          <ul><li>e.g: listening to legendItem._tableToggled to toggle custom table plugin</li></ul>
 *     </li>
...
class BaseItem {
    ...
    */
     ...
     * @return {boolean | undefined} - true if the item is currently visible, false if invisible
     *                               - undefined if "visibility" is not.part of `BaseItem's`  `_availableControls`.
     */
    ...
    */
     ...
     * @return {number | undefined} - ranges from 0 (hidden) to 1 (fully visible).
     *                              - undefined if "opacity" is not.part of `BaseItem's` `_availableControls`.
     */
    ...
    * @return {boolean|undefined} - true if the item is queryable, false otherwise.
    *                             - undefined if "query" is not.part of `BaseItem's` `_availableControls`.
    */
