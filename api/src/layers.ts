        ...
        if (this._layerType === layerTypes.ESRI_DYNAMIC) {
            ...
            this._layerProxy._source._layerPackage.layerData.then((value: any) => {
                ...
                for (let field of fields) {
                    ...
                    this.attributeHeaders[field.name]['id'] = field.name;
                    this.attributeHeaders[field.name]['name'] = configHeaders[field.name] ? configHeaders[field.name] : field.alias || field.name;
                }
            })
        }
