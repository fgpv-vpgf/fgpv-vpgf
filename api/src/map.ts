...
function generateMouseClickObservable(esriMapElement: HTMLElement, singleClick: boolean) {
    const clickStream = Observable.fromEvent(esriMapElement, 'click');
...
function initObservables(this: Map) {
    ...
    this.click = generateMouseClickObservable(esriMapElement, true);
    this.doubleClick = generateMouseClickObservable(esriMapElement, false);
