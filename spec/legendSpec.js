...
const sampleLayer = { y:0, headerHeight: 0, height: 110, type: 'layer', items: [{ type:'group',
    items:[{ type:'item', height:20, y: 10 }, { type:'item', height:40, y: 30 }], headerHeight: 10, y: 0 },
    { type:'item', height:20, y: 70 }, { type:'item', height:20, y: 90 }] };
