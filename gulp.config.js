...
module.exports = function () {
    ...
    config.iconCache = [
        ...
        { file: 'content/images/iconsets/mdi-icons.svg', prefix: 'community', icons: 'filter chevron-double-left emoticon-sad emoticon-happy vector-square table-large map-marker-off apple-keyboard-control'.split(' ') },
