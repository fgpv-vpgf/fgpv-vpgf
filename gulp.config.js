...
module.exports = function () {
    ...
    config.iconCache = [
        ...
        { file: 'content/images/iconsets/action-icons.svg', prefix: 'action', icons: 'settings_input_svideo search home history description delete settings info_outline info visibility visibility_off zoom_in zoom_out check_circle open_in_new print shopping_cart opacity swap_vert touch_app translate settings_overscan'.split(' ') },
