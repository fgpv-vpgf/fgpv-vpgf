...
module.exports = function () {
    ...
    config.iconCache = [
        ...
        { file: 'content/images/iconsets/navigation-icons.svg', prefix: 'navigation', icons: 'menu check more_vert close more_horiz refresh arrow_back arrow_upward arrow_downward'.split(' ') },
