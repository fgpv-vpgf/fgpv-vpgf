...
module.exports = function () {
    ...
    config.iconCache = [
        { file: 'content/images/iconsets/default-icons.svg', prefix: 'default', icons: 'check logo northarrow snowman'.split(' '), isDefault: true },
        ...
        { file: 'content/images/iconsets/hardware-icons.svg', prefix: 'hardware', icons: 'keyboard_arrow_right keyboard_arrow_left keyboard_arrow_down keyboard_arrow_up'.split(' ') },
