...
$.getScript('../../../../rv-main.js', function () {
    RAMP.mapAdded.subscribe((mapi) => {
        ...
        const poly4 = new RAMP.GEO.Polygon(204, [
            [-73.16709, 45.91105],
            [-73.16709, 45.91108],
            [-73.1671, 45.91117],
            [-73.16711, 45.91123],
        ...
        const polyAll = new RAMP.GEO.MultiPolygon(206, [poly1, poly2, poly3, poly4, poly5]);

        // create hovers
        const hoverPointA = new RAMP.GEO.Hover(0, 'This hover closes.', { position: 'right' });
        const hoverPointB = new RAMP.GEO.Hover(1, 'This hover is kept open.', { keepOpen: true, position: 'left' });
