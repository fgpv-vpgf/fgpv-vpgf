(() => {
     ...
     * it should be built so it does not leak any ESRI specifc concepts through the rest of the application.
     * And, as far as possible, it should minimize the amount of GIS specifc functionality needs to be built
     * outside the module.
     */
