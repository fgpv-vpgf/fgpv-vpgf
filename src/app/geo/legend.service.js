        ...
        */
        ...
        function applySymbology(state, layerData) {
            state.symbology = layerData.legend.map(item => {
                // extract the base of our image format.
                // results from a legend generated by geoApi will have a .base property defined.
                // results from an esri legend service will not, and we can assume base64.
                // note that .base can have a value of '', so falsy checks will wreck you here.
                let base = item.base;
                if (typeof base === 'undefined') {
                    base = ';base64';
                }
                return {
                    icon: `data:${item.contentType}${base},${item.imageData}`,
                    name: item.label
                };
            });
        }
