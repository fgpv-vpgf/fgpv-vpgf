    ...
    function layerRegistryFactory($q, $timeout, gapiService, legendService, layerTypes, layerStates, layerDefaults) {
        ...
        function layerRegistry(geoState, mapObject, config) {
            ...
            function registerLayer(layer, initialState, attribs) {
                ...
                // any further visibility changes should be done on a legend item generated by the `legendService`
                // -->>>> layer.setVisibility(initialState.options.visibility.value === 'on');
