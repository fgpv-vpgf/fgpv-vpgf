(() => {
    ...
    function Controller($mdDialog, $translate, version, sideNavigationService, geoService, // jshint ignore:line
        ...
        $rootScope, events, stateManager, $rootElement, globalRegistry, appInfo) {
        ...
        globalRegistry.Plugin.BasePlugin.onCreate(appInfo.id, 'MenuItem', mItem => self.menu[0].children.push(mItem));
