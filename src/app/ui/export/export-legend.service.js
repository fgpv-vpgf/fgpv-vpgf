...
function exportLegendService($q, $rootElement, appInfo, LegendBlock, configService, gapiService, graphicsService) {
    ...
    async function generate(availableHeight = 500, availableWidth = 1500, preferredSectionWidth = 500, numColumns = 0, layersToInclude = [], showToast) {
        ...
        // the default values were not being applied correctly, they were remaining null, which causes an infinite loop due to a negative width somewhere lower down in this function
        // TODO: fix this so default values are applied correctly
        availableHeight = availableHeight || 500;
        availableWidth = availableWidth || 1500;
        preferredSectionWidth = preferredSectionWidth || 500;
