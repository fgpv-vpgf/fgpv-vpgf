...
function exportService(
    ...
    events.$on(events.rvMapLoaded, (_, i) => {
        ...
        // expose the export generators on the map instance which exposes it on the API
    ...
    function ExportController(
        ...
        exportComponentsService.init().then(() => {
            ...
            if (appInfo.features.export) {
                console.log('appInfo.features.export', appInfo.features.export);
                ...
                // NOTE: `angular.copy()` doesn't seem to work properly, so we use this other method instead
