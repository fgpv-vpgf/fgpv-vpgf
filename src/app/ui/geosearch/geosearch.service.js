(() => {
    ...
    function geosearchService(stateManager, storageService, debounceService, geoSearch, $rootScope) {
        ...
        const debToggleGeo = debounceService.registerDebounce(() => {
            ...
            extentEvent = $rootScope.$on('extentChange', debounceService.registerDebounce(onExtentChange, 300, false));
        });
