        ...
        */
        ...
        function HelpSummaryController($http, configService) {
            ...
            $http.get(mdLocation).then(r => {
                ...
                // note that the {5,} below is used as the double line deparator since each double new line is actually 6
                ...
                // replace new line character ASCII (13) with ASCII (10 - \n) so that above regex is compatible with all
