 ...
 * @description
 *
 * The `rvBasemap` directive displays a basemap selector. Its templateUrl uses a content pane which is loaded into the `other` panel opening on the right side of the screen. Selector groups basemaps by projection.
 *
 */
angular
    .module('app.ui')
