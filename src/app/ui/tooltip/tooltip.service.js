...
function tooltipService($rootScope, $compile, $q, storageService, events) {
    ...
    class Tooltip {
         ...
         * @param {Object} scope scope for the tooltip directive; this scope is also available on the content templateUrl
         * @param {String} templateName [optional = 'hover'] the name of the tooltip outer templateUrl
         */
        constructor (movementStrategy, collisionStrategy, content, scope, templateName = 'hover') {
            ...
            this._node = $compile(`<rv-tooltip templateUrl="${this._templateName}">${content}</rv-tooltip>`)(scope);
    ...
    /**
     * Triggers a digest cycle on the tooltip's scope object to udpate the templateUrl if tooltip's content changed outside Angular modules.
