 ...
 * Identify results is rendered when the collapsed section header is hovered over or receives focus. This removes the slight delay when compiled html is inseted into the templateUrl on section expand.
 *
 */
angular
    .module('app.ui')
...
function rvDetailsRecordEsrifeature($compile, $filter, geoService, Geo) {
    ...
    function link(scope, el) {
        ...
        /**
         * Render details as plain html and insert them into the templateUrl. Runs only once.
