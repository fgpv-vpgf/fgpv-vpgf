    ...
    function keyboardDragula(el, scope, drake, dragulaOptions) {
        ...
        function dropElement(event, target) {
            ...
            if (dropIndex !== dragIndex) {
                ...
                scope.$digest(); // run digest cycle so repeater can update the templateUrl according to the changed model
                scope.$applyAsync(() => // schedule setting focus back to the drag handle on a future digest cycle after templateUrl is updated
