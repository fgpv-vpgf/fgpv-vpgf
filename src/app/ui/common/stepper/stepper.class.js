 ...
 * Other components should import `Stepper`, create a new stepper object using `new Stepper()` and add steps to it in the order they appear in the templateUrl.
...
function StepperFactory($q, $rootElement, $timeout) {
    ...
    class Stepper {
         ...
         * a step object must have two properties: `isActive` and `isCompleted`; they are bound to the `step-item` templateUrl and determine the visual appearance of a step;
