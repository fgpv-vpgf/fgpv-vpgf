...
(() => {
     ...
     * @description
     *
     * The `rvLayerItemSymbology` directive generates a symbology list and toggles its visibility. It also wiggles th stacked symbology icons on mouse over and focus.
     *
     * ```html
