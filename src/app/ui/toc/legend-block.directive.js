 ...
 * <!-- `type` attribute indicates which templateUrl will be used -->
...
function rvLegendBlock(tocService, $compile, $templateCache, appInfo, common) {
    ...
    function link(scope, element) {
        ...
        scope.$watch('self.block.templateUrl', newTemplate => {
            if (newTemplate) {
                const templateUrl = $templateCache.get(`app/ui/toc/templates/legend-${newTemplate}.html`);
                element.empty().append($compile(templateUrl)(scope));
