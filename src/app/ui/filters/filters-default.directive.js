            ...
            function createTable(oLang) {
                ...
                self.table = tableNode
                    ...
                    .DataTable({
                        ...
                        keys: {
                            keys: [37, 38, 39, 40], // only navigate with arrow key
                ...
                function onTableInit() {
                    ...
                    forcedDelay.then(() => {
                        ...
                        $('.dataTables_scrollBody').attr('rv-ignore-focusout', '');
                    });
                }
                ...
                function setkeytable() {
                    ...
                    // table cell it goes inside the menu and loop trouht it at the same time as we navigate the table
                    $timeout(() => { $rootElement.find('[type=\'filters\'] button.rv-close').focus(true); }, 100);

                    // when we navigate with the keyboard, the scroller extension has buffer items in memory. Whitout this
                    ...
                    self.table.on('key-focus', (e, datatable, cell) => {
                        ...
                        // if there is a button inside the node, focus to it so keyboard user can interact whit it
