                ...
                columns.forEach((column, i) => {
                    ...
                    if (i > 1) {
                        ...
                        if (column.type === 'number') {
                            ...
                            // TODO: find a way to compare not case sensitive value (layers definition querytask) (last item false)
                            table.column(`${column.name}:name`).search(val, true, false, false);
                        }
