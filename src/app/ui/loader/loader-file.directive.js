(() => {
    ...
    function Controller($scope, $q, $timeout, stateManager, Stepper, geoService, LayerBlueprint, Geo, appInfo) {
        'ngInject';
        const self = this;
        ...
        function closeLoaderFile() {
            ...
            $timeout(() => {
                $(document.getElementById(appInfo.id)).find('.rv-loader-add').first().focus(true);
            }, 0);
        }
    }
})();
