(() => {
    ...
    function Controller($scope, $q, $timeout, stateManager, Stepper, geoService, LayerBlueprint, Geo) {
         ...
         */
        function configureOnContinue() {
            // this check is performed because file validation happens for other file types in the select step
            if (self.layerBlueprint.fileType === 'csv') {
                self.layerBlueprint.generateLayer(self.layerBlueprint.fileType)
                    .then(() => {
