(() => {
    ...
    function Controller($timeout, stateManager, geoService, Geo, Stepper, LayerBlueprint) {
        ...
        /**
         * Clears service url field and all error displayed; sets the form into prestine, untouched state (so no default validation errors (like "required" or "not a proper url") will show)
         */
