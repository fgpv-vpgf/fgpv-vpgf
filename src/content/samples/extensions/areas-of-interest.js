window.areasOfInterest = {
    ...
    init: function(api){
        ...
        let mapConfig = this.config;
        let zones = mapConfig.map.components.areaOfInterest._source.areas;
        let noPic = mapConfig.map.components.areaOfInterest._source.noPicture;
        let zoneList = ' ';
        let title = translations[mapConfig.language];
        ...
        let panel0 = map.createPanel('area-of-interest');
