//translations (not going to change)
const translations = {
    'en-CA': 'Areas of Interest',
    'fr-CA': 'Zones d\'intérêt'
};

//initialize attributes (not going to change)
...
//append define and append setExtent to head
let setExtent = `
<script>
...
//if areas of interest provided, create panel contents (not going to change)
if (zones !== undefined) {
