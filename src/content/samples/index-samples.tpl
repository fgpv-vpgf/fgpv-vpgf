    ...
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                ...
                <option value="config/config-sample-64-c.json">64. a) Side menu Area of interest plugin (Pictures Enabled)</option>
                <option value="config/config-sample-64-d.json">64. b) Side menu Area of interest plugin (No Pictures)</option>
