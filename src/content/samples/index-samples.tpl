    ...
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                ...
                <option value="config/config-sample-64.json">64 a). Side menu Area of interest plugin (Pictures)</option>
                <option value="config/config-sample-64-b.json">64 b). Side menu Areas of interest plugin (No Pictures)</option>
