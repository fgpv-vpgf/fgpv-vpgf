          ...
          <div id="fgpSignIn" class="row">
            <div class="panel panel-default">
                <div class="panel-body clearfix">
                    ...
                    <div id="fgpmap" is="rv-map" class="myMap" data-rv-config="config.rcs.[lang].json" data-rv-langs='["en-CA", "fr-CA"]' data-rv-service-endpoint="http://section917.cloudapp.net:8000/" data-rv-keys='' data-rv-wait="true" rv-extensions="extensions/hello-world.js">
                        <noscript>
