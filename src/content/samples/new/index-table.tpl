...
<body>
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                <option value="config/config-sample-columns.json">01. Columns</option>
                <option value="config/config-sample-settings.json">02. Settings</option>
            </select>
        </div>
    ...
    <div class="myMap" id="sample-map" is="rv-map" ramp-gtm
        rv-config="config/config-sample-columns.json"
