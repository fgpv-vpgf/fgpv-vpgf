...
<body>
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                <option value="config/config-sample-failure-01.json">01. Failure Testing</option>
                <option value="config/config-sample-failure-02.json">02. Initial Broken Basemap</option>
            </select>
        </div>
    ...
    <div class="myMap" id="sample-map" is="rv-map" ramp-gtm
        rv-config="config/config-sample-failure-01.json"
