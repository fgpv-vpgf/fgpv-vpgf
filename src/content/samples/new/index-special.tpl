...
<body>
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                <option value="config/config-sample-customESRI.json">01. Custom ESRI API location</option>
                <option value="config/config-sample-CORS.json">02. CORS everywhere</option>
                <option value="config/config-sample-customRender.json">03. Custom layer renderer on client</option>
                <option value="config/config-sample-removedLegendTitles.json">04. Legend with titles that are removed in export and custom legend width</option>
                <!-- <option value="config/config-sample-getCoordInfo.json">05. Use https for Get Coord Info plugin</option> -->
                <option value="config/config-sample-localExport.json">05. Local Export + Tainted Images + cleanCanvas option</option>
            </select>
        </div>
    ...
    <div class="myMap" id="sample-map" is="rv-map" ramp-gtm
        rv-config="config/config-sample-customESRI.json"
