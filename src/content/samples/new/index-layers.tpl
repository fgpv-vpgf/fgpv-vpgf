...
<body>
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                <option value="config/config-sample-layers-01-visibility.json">1a. Layer Settings: Opacity and Visibility Tests</option>
                <option value="config/config-sample-layers-01-settings.json">1b. Layer Settings: Other Settings Panel Features</option>
                <option value="config/config-sample-layers-01-controls.json">1c. Layer Settings: Control Tests</option>
    ...
    <div class="myMap" id="sample-map" is="rv-map" ramp-gtm
        rv-config="config/config-sample-layers-01-visibility.json"
