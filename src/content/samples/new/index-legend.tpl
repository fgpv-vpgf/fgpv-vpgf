...
<body>
    <section id="header">
        <div class="row">
            <select id="selectConfig" class="tool">
                <option value="config/config-sample-structure.json">01. Structure</option>
                <option value="config/config-sample-entryFormat.json">02. Entry format</option>
                <option value="config/config-sample-autoLegendNoReorder.json">03. Re-order disabled for auto legends</option>
                <option value="config/config-sample-layerReordering.json">04. Layer re-ordering enabled</option>
                <option value="config/config-sample-visibilitySets.json">05. Visibility Sets</option>
                <option value="config/config-sample-linkedLayers.json">06. Linked Layers</option>
                <option value="config/config-sample-zoomScaleDependency.json">07. Zoom Scale Dependency</option>
            </select>
        </div>
    ...
    <div class="myMap" id="sample-map" is="rv-map" ramp-gtm
        rv-config="config/config-sample-structure.json"
