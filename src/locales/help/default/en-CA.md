...
- Move the map and zoom the item corresponding to a given line by selecting the *Zoom To Feature* icon (![](datatable/zoomto.png))
...
The number of entities in the layer is displayed in the top left corner below the layer title:
