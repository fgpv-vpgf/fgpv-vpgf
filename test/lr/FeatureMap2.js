...
geoapi('http://js.arcgis.com/3.14/', window).then(function (api) {
    console.log('TEST PAGE - Zoom To Feature (point) on scale dependant Feature Layer Record');

        var config1 = {
        id: 'dog',
        name: 'Feature Test',
        url: 'http://maps-cartes.ec.gc.ca/arcgis/rest/services/CESI/CESI_AirEmissions_CO/MapServer/1',
    ...
    function afterLoadTests() {
        ...
        // zoom to a point
        proxy.zoomToGraphic(72144, map, { x:0, y:0 }).then(() => {
