 ...
 * @return {Stream}
 */
gulp.task('test', 'Run style checks and unit tests', ['vet', 'templatecache', 'translate'], function (done) {
 ...
 */
gulp.task('test:auto', 'Run unit tests and keep watching for changes', ['vet', 'templatecache', 'translate'], function (done) {
